...
class Block{
  ...
  public:
    ...
    Block(TRANSACTION *_data, unsigned long int _nonce = 1 ){
      ...
      this->prev = string(64, '0');
      this->hash = new SHA256(data->get_data() + this->prev); 
      if(hash->hash_result.substr(0, 4) != "0000") this->is_valid = false; 
    ...
    void reHash(){
      this->hash = new SHA256(data->get_data() + this->prev); 
      if(hash->hash_result.substr(0, 4) != "0000" || this->prev.substr(0, 4)!= "0000") this->is_valid = false; 
      else this->is_valid = true;
    }
    ...
    void show_block_info(){
      cout << endl; 
      cout << endl << "****************************************************";
      cout << endl << "Block id: " << this->id; 
      cout << endl << "Nonce : " << this->nonce; 
      cout << endl << "----------------------------------------";
      cout << endl << "Sender: " << this->data->senderKey; 
      cout << endl << "Reciever: " << this->data->recieverKey; 
      cout << endl << "Amount: " << this->data->amount;  
      cout << endl << "Time: " << this->data->timestamp;  
      cout << endl << "----------------------------------------" << endl;
      cout << endl << "Hash Value: " << this->hash->hash_result; 
      cout << endl << "Prev Hash: " << this->prev; 
      cout << endl << "Valid block: " << boolalpha << this->is_valid; 
      cout << endl << "****************************************************";
    }

    void modify(string name) {
            this->data->recieverKey = name;
            this->hash = new SHA256(data->get_data() + this->prev);
