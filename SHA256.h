...
static string text_to_binary(string data);
static string integer_to_binary_bits(int char_to_int, int cant_bits);
static string bits_to_hexadecimal(uint32_t data);
static int binary_to_int(string binaryString);

static uint32_t operandRotR(uint32_t X, int base);
static uint32_t operandShR(uint32_t X, int base);
static uint32_t operandMaj(uint32_t X, uint32_t Y, uint32_t Z);
static uint32_t operandCh(uint32_t X, uint32_t Y, uint32_t Z);
static uint32_t operandSn(uint32_t X, int n);
static uint32_t operandOn(uint32_t X, int n);
